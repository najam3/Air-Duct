  ...
  return (
    <section className="px-4 py-16 bg-neutral50">
      ...
      <div className="flex-container flex-col lg:flex-row justify-around flex-wrap mt-10 gap-12 flex w-[95%] mx-auto items-center">
        <img src={src1} className="w-1/2 md:w-[20%] xl:w-[15%]" alt="" />
        <img src={src2} className="w-1/2 md:w-[15%] xl:w-[10%]" alt="" />
        <img src={src3} className="w-1/2 md:w-[20%] xl:w-[15%]" alt="" />
        <img src={src4} className={`${src4 || "hidden"} w-1/2 md:w-[20%] xl:w-[15%]`} alt="" />
        <img src={src5} className="w-1/2 md:w-[20%] xl:w-[15%]" alt="" />
      </div>
    </section>
  );
};
